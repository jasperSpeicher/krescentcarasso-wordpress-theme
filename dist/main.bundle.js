...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_service__ = __webpack_require__(509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu_menu_service__ = __webpack_require__(512);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__page__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_service__ = __webpack_require__(333);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_service__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__menu_menu_service__ = __webpack_require__(512);
...
var PageSingleComponent = (function () {
    ...
    PageSingleComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            if (parent === 'explore') {
                _this.page = null;
                _this.getPage(slug);
                _this.menuService.getMenuObservable()
                    .subscribe(function (menu) {
                    if (menu) {
                        menu.getActiveTermObservable().subscribe(function (termSlug) {
                            _this.filterImageGrid(termSlug);
                        });
                    }
                    if (slug !== undefined) {
                        _this.menuService.menu.activeTerm = slug;
                    }
                });
            }
            else {
    ...
    PageSingleComponent.prototype.filterImageGrid = function (termSlug) {
        console.log('filter ' + termSlug);
    };
    PageSingleComponent.prototype.updateImageGrid = function () {
        var transitionDuration = 800;
        var imageGridElement = document.querySelector('.theme-image-grid');
        if (imageGridElement) {
            if (!this.imageGrid) {
                ...
                var _self_1 = this;
                imageGridElement.addEventListener('click', function (event) {
                    ...
                    _self_1.safeImageGridShiftLayout();
                    setTimeout(function () {
                        event.target.classList.toggle('theme-image-grid__image--large');
                        _self_1.safeImageGridFitLayout(event.target);
    ...
    PageSingleComponent.prototype.safeImageGridLayout = function () {
        console.log('safe imageGrid layout');
        Packery.layoutOnViewChecked = false;
        this.imageGrid.layout();
    };
    PageSingleComponent.prototype.safeImageGridShiftLayout = function () {
        console.log('safe imageGrid shift layout');
        Packery.layoutOnViewChecked = false;
        this.imageGrid.shiftLayout();
    };
    PageSingleComponent.prototype.safeImageGridFitLayout = function (element) {
    ...
    PageSingleComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__pages_service__["a" /* PagesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__pages_service__["a" /* PagesService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["ActivatedRoute"]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__menu_menu_service__["a" /* MenuService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__menu_menu_service__["a" /* MenuService */]) === 'function' && _d) || Object])
    ], PageSingleComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_page_single_page_single_component__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_page_home_page_home_component__ = __webpack_require__(330);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__posts_post_list_post_list_component__ = __webpack_require__(513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_routing_module__ = __webpack_require__(507);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__posts_post_single_post_single_component__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_page_single_page_single_component__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_page_home_page_home_component__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__menu_menu_component__ = __webpack_require__(511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_page_transition__ = __webpack_require__(669);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_service__ = __webpack_require__(512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_filter__ = __webpack_require__(688);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_mergeMap__ = __webpack_require__(689);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__menu__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_BehaviorSubject__ = __webpack_require__(234);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__posts_service__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(65);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_BehaviorSubject__ = __webpack_require__(234);
